(function(d, $) {
    ...
    Ba = -1 !== H.indexOf("mobile"),
    I = d.browser,
    pa = parseFloat(I.version),
    i = I.msie,
    qa = I.mozilla,
    R = I.safari,
    Ca = I.opera,
    eb = -1 < H.indexOf(" adobeair/"),
    Da = /OS 5(_\d)+ like Mac OS X/i.test(H);
    d.fn.xheditor = function(i) {
        if (Ba && !Da) return ! 1;
        var o = [];
        this.each(function() {
            if (d.nodeName(this, "TEXTAREA")) if (!1 === i) {
    ...
    ta = !1,
    Sa = !1,
    t, ba, ca, da, J, Ea, ea, Fa, Ga, Ha, K;
    d("script[src*=xheditor]").each(function() {
        var d = this.src;
        if (d.match(/xheditor[^\/]*\.js/i)) return K = d.replace(/[\?#].*$/, "").replace(/(^|[\/\\])[^\/]*$/, "$1"),
        !1
    });
    if (i) {
        try {
            document.execCommand("BackgroundImageCache", !1, !0)
        } catch(qb) {} (H = d.fn.jquery) && H.match(/^1\.[67]/) && (d.attrHooks.width = d.attrHooks.height = null)
    }
    var fb = {
        27 : "esc",
        9 : "tab",
    ...
    ra = function(z, o) {
        ...
        function H(a) {
            if (27 === a.which) return ta ? c.removeModal() : S && c.hidePanel(),
            !1
        }
        function I() {
        ...
        function Ua(a) {
            var b, e, f;
            if (a && (b = a.originalEvent.clipboardData) && (e = b.items) && (f = e[0]) && "file" == f.kind && f.type.match(/^image\//i)) return a = f.getAsFile(),
            b = new FileReader,
            b.onload = function() {
            ...
            !1;
            var h = g.cleanPaste;
            if (0 === h || y || Ja) return ! 0;
            Ja = !0;
            c.saveBookmark();
            var a = i ? "pre": "div",
            n = d("<" + a + ' class="xhe-paste">\ufeff\ufeff</' + a + ">", k).appendTo(k.body),
            a = n[0];
            b = c.getSel();
            e = c.getRng(!0);
        ...
        function Va(a) {
            ...
            e = g.remoteImgSaveUrl;
            if (b && e) {
                var f = [],
                h = 0,
                a = a.replace(/(<img)((?:\s+[^>]*?)?(?:\s+src="\s*([^"]+)\s*")(?: [^>]*)?)(\/?>)/ig,
                function(a, e, c, d, r) { / ^(https ? |data: image) / i.test(d) && !b.test(d) && (f[h] = d, c = c.replace(/\s+(width|height)="[^"]*"/ig, "").replace(/\s+src="[^"]*"/ig, ' src="' + ua + 'img/waiting.gif" remoteimg="' + h+++'"'));
                    return e + c + r
                });
                0 < f.length && d.post(e, {
                    urls: f.join("|")
        ...
        function Ba(a) {
            if (y || 13 !== a.which || a.shiftKey || a.ctrlKey || a.altKey) return ! 0;
            ...
            i && 0 < a.length && 2 === c.getRng().parentElement().childNodes.length && c.pasteHTML("<br />"),
            !1
        }
        function Na() { ! qa && !R && (la && A.height("100%").css("height", A.outerHeight() - q.outerHeight()), i && q.hide().show())
        }
        function Da(a) {
            a = a.target;
        ...
        function L(a, b, e) {
            if (!b) return ! 1;
            var c = "_xhe_" + b;
            e && (va && (e = V(e, va, B)), a.attr(b, B ? V(e, "abs", B) : e).removeAttr(c).attr(c, e));
        ...
        function ob(a) {
            ...
            var b = a.which,
            e = fb[b],
            b = e ? e: String.fromCharCode(b).toLowerCase();
            sKey = "";
            sKey += a.ctrlKey ? "ctrl+": "";
            sKey += a.altKey ? "alt+": "";
            ...
            var a = ma[sKey],
            f;
            for (f in a) if (f = a[f], d.isFunction(f)) {
        ...
        function M(a, b) {
            var e = typeof a;
            return ! b ? "undefined" != e: "array" === b && a.hasOwnProperty && a instanceof Array ? !0 : e === b
        }
        function V(a, b, e) {
            if (a.match(/^(\w+):\/\//i) && !a.match(/^https?:/i) || /^#/i.test(a) || /^data:/i.test(a)) return a;
            var c = e ? d('<a href="' + e + '" />')[0] : location,
            e = c.protocol,
            h = c.host,
            n = c.hostname,
            j = c.port,
            ...
            if ("rel" !== b && (a.match(/^(https?:\/\/|\/)/i) || (a = c + a), "/" === a.charAt(0))) {
                for (var n = [], a = a.split("/"), l = a.length, c = 0; c < l; c++) j = a[c],
                ".." === j ? n.pop() : "" !== j && "." !== j && n.push(j);
                "" === a[l - 1] && n.push("");
                a = "/" + n.join("/")
            }
        ...
        P = "",
        Q = "",
        ua = K + "xheditor_skin/" + g.skin + "/",
        Aa = kb,
        va = g.urlType,
        B = g.urlBase,
        Y = g.emotPath,
        Y = Y ? Y: K + "xheditor_emot/",
        Ra = "",
        Aa = d.extend({},
        Aa, g.emots),
        Y = V(Y, "rel", B ? B: null); (na = g.showBlocktag) && (Q += " showBlocktag");
        var ma = [];
        this.init = function() {
            ...
            function(a, b) {
                ...
                if ("|" === b) e.push('<span class="xheSeparator"/>');
                else if ("/" === b) e.push("<br />");
                else {
                    f = ka[b];
                    if (!f) return;
                ...
                b.match(n) && e.push('<span class="xheGStart"/>')
            });
            ...
            fa = d(W);
            try {
                this.doc = k = W.document,
                ga = d(k),
                k.open(),
                k.write(j),
                k.close(),
                i ? k.body.contentEditable = "true": k.designMode = "On"
            } catch(l) {}
            setTimeout(La, 300);
            c.setSource();
            W.setInterval = null;
            q.append(e.join("")).bind("mousedown contextmenu", N).click(function(a) {
                ...
                b.is(".xheEnabled") && (clearTimeout(wa), q.find("a").attr("tabindex", "-1"), w = a, c.exec(b.attr("cmd")));
                return ! 1
            });
            q.find(".xheButton").hover(function(a) {
                ...
                m = X;
                X = null;
                if ( - 1 === e || oa || !b.is(".xheEnabled")) return ! 1;
                if (m && 10 < m) return oa = !0,
                setTimeout(function() {
                    oa = !1
                },
                100),
                !1;
                var f = b.attr("cmd");
                if (1 !== ka[f].h) return c.hidePanel(),
                !1;
                Qa && (e = 0);
            ...
            function() {
                ...
                if (ia) {
                    ...
                    c = a.clientY - ia.y;
                    if (1 < Math.abs(b) || 1 < Math.abs(c)) 0 < b && 0 < c ? (b = Math.round(Math.atan(c / b) / 0.017453293), X = X ? (X + b) / 2 : b) : X = null,
                    ia = {
                        x: a.clientX,
                        y: a.clientY
                    }
            ...
            R && fa.click(Da);
            ga.mousedown(Oa).keydown(ob).keypress(Ba).dblclick(p).bind("mousedown click",
            function(a) {
                F.trigger(a.type)
            });
            if (i) {
                ga.keydown(function(a) {
                    var b = c.getRng();
                    if (8 === a.which && b.item) return d(b.item(0)).remove(),
                    !1
                });
                var u = function(a) {
                    var a = d(a.target),
            ...
            function(a) {
                var b;
                if ((b = a.originalEvent.dataTransfer.types) && -1 !== d.inArray("Files", b)) return ! 1
            }).bind("drop",
            function(a) {
                var a = a.originalEvent.dataTransfer,
                b;
                if (a && (b = a.files) && 0 < b.length) {
                    var e, f, a = ["Link", "Img", "Flash", "Media"],
                    j = [],
                    h;
                    for (e in a) f = a[e],
                    g["up" + f + "Url"] && g["up" + f + "Url"].match(/^[^!].*/i) && j.push(f + ":," + g["up" + f + "Ext"]);
                    if (0 === j.length) return ! 1;
                    h = j.join(",");
                    f = function(a) {
                        var b, c;
                        for (e = 0; e < a.length; e++) if (b = a[e].name.replace(/.+\./, ""), b = h.match(RegExp("(\\w+):[^:]*," + b + "(?:,|$)", "i"))) if (c) {
                            if (c !== b[1]) return 2
                        } else c = b[1];
                        else return 1;
                        return c
                    } (b);
                    1 === f ? alert("\u4e0a\u4f20\u6587\u4ef6\u7684\u6269\u5c55\u540d\u5fc5\u9700\u4e3a\uff1a" + h.replace(/\w+:,/g, "")) : 2 === f ? alert("\u6bcf\u6b21\u53ea\u80fd\u62d6\u653e\u4e0a\u4f20\u540c\u4e00\u7c7b\u578b\u6587\u4ef6") : f && c.startUpload(b, g["up" + f + "Url"], "*",
                    function(a) {
                        var b = [],
                        e; (e = g.onUpload) && e(a);
                        for (var r = 0,
                        j = a.length; r < j; r++) e = a[r],
                        url = M(e, "string") ? e: e.url,
                        "!" === url.substr(0, 1) && (url = url.substr(1)),
                        b.push(url);
                        c.exec(f);
                        d("#xhe" + f + "Url").val(b.join(" "));
                        d("#xheSave").click()
                    });
                    return ! 1
                }
            }); (j = g.shortcuts) && d.each(j,
            function(a, b) {
                c.addShortcuts(a, b)
            });
            aa++;
        ...
        this.setTextCursor = function(a) {
            var b = c.getRng(!0),
            e = k.body;
            if (i) b.moveToElementText(e);
            else {
                for (var d = a ? "lastChild": "firstChild"; 3 != e.nodeType && e[d];) e = e[d];
                b.selectNode(e)
            }
            b.collapse(a ? !1 : !0);
        ...
        this.getRng = function(a) {
            var b, e;
            try {
                a || (b = c.getSel(), e = b.createRange ? b.createRange() : 0 < b.rangeCount ? b.getRangeAt(0) : null),
                e || (e = k.body.createTextRange ? k.body.createTextRange() : k.createRange())
            } catch(d) {}
            return e
        };
        ...
        this.getSelect = function(a) {
            ...
            e = c.getRng(),
            f = !0,
            f = !e || e.item ? !1 : !b || 0 === e.boundingWidth || e.collapsed;
        ...
        this.pasteHTML = function(a, b) {
            ...
            if (f.insertNode) {
                if (0 < d(f.startContainer).closest("style,script").length) return ! 1;
                f.deleteContents();
                f.insertNode(f.createContextualFragment(a))
            } else "control" === e.type.toLowerCase() && (e.clear(), f = c.getRng()),
            f.pasteHTML(a);
            var h = d("#_xhe_temp", k),
            n = h[0];
        ...
        this.processHTML = function(a, b) {
            if ("write" === b) {
                ...
                function(a, b, c, e, d, f, h) {
                    ...
                    var m, x = "";
                    if ("del" === e) e = "strike";
                    else if ("img" === e) d = d.replace(/\s+emot\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/i,
                    function(a, b) {
                        m = b.match(/^(["']?)(.*)\1/)[2];
                        m = m.split(",");
                        m[1] || (m[1] = m[0], m[0] = "");
                    ...
                    else if ("a" === e) ! d.match(/ href=[^ ]/i) && d.match(/ name=[^ ]/i) && (x += " xhe-anchor"),
                    h && (f = "></a>");
                    else if ("table" === e && !c && (a = d.match(/\s+border\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/i), !a || a[1].match(/^(["']?)\s*0\s*\1$/))) x += " xhe-border";
                    var Z, d = d.replace(/\s+([\w\-:]+)\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/g,
                    function(a, b, c) {
                        b = b.toLowerCase();
                        c = c.match(/^(["']?)(.*)\1/)[2];
                        aft = "";
                        if (i && b.match(/^(disabled|checked|readonly|selected)$/) && c.match(/^(false|0)$/i) || "img" === e && m && "src" === b) return "";
                    ...
                    m && (a = Y + (m[0] ? m[0] : "default") + "/" + m[1] + ".gif", d += ' src="' + a + '" _xhe_src="' + a + '"');
                    Z && (d += ' class="Apple-style-span"');
                    x && (d += ' class="' + x + '"');
                    return "<" + c + e + d + f
                });
                i && (a = a.replace(/&apos;/ig, "&#39;"));
                if (!R) var e = function(a, b, e, c, d, f) {
                    var b = "",
                    h, m; (h = c.match(/font-family\s*:\s*([^;"]+)/i)) && (b += ' face="' + h[1] + '"');
                    if (h = c.match(/font-size\s*:\s*([^;"]+)/i)) {
                        h = h[1].toLowerCase();
                        for (var x = 0; x < T.length; x++) if (h === T[x].n || h === T[x].s) {
                            m = x + 1;
                            break
                        }
                    ...
                    if (m = c.match(/(?:^|[\s;])color\s*:\s*([^;"]+)/i)) {
                        if (h = m[1].match(/\s*rgb\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/i)) {
                            m[1] = "#";
                            for (x = 1; 3 >= x; x++) m[1] += (h[x] - 0).toString(16)
                        }
                ...
                a = a.replace(/<(span)(\s+[^>]*?)?\s+style\s*=\s*"((?:[^"]*?;)?\s*(?:font-family|font-size|color)\s*:[^"]*)"( [^>]*)?>(((?!<\1(\s+[^>]*?)?>)[\s\S]|<\1(\s+[^>]*?)?>((?!<\1(\s+[^>]*?)?>)[\s\S]|<\1(\s+[^>]*?)?>((?!<\1(\s+[^>]*?)?>)[\s\S])*?<\/\1>)*?<\/\1>)*?)<\/\1>/ig, e),
                a = a.replace(/<(span)(\s+[^>]*?)?\s+style\s*=\s*"((?:[^"]*?;)?\s*(?:font-family|font-size|color)\s*:[^"]*)"( [^>]*)?>(((?!<\1(\s+[^>]*?)?>)[\s\S]|<\1(\s+[^>]*?)?>((?!<\1(\s+[^>]*?)?>)[\s\S])*?<\/\1>)*?)<\/\1>/ig, e),
                a = a.replace(/<(span)(\s+[^>]*?)?\s+style\s*=\s*"((?:[^"]*?;)?\s*(?:font-family|font-size|color)\s*:[^"]*)"( [^>]*)?>(((?!<\1(\s+[^>]*?)?>)[\s\S])*?)<\/\1>/ig, e);
                ...
                },
                {
                    ...
                    t: "strike"
                }], e = function(a, b, e, d, h) {
                    for (var a = (e ? e: "") + (d ? d: ""), g = [], D = [], m, e = 0; e < c.length; e++) b = c[e].r,
                    m = c[e].t,
                    a = a.replace(b,
                    function() {
                        g.push("<" + m + ">");
                ...
                d = 0; 2 > d; d++) a = a.replace(/<(span)(\s+[^>]*?)?\s+class\s*=\s*"Apple-style-span"(\s+[^>]*?)?>(((?!<\1(\s+[^>]*?)?>)[\s\S]|<\1(\s+[^>]*?)?>((?!<\1(\s+[^>]*?)?>)[\s\S]|<\1(\s+[^>]*?)?>((?!<\1(\s+[^>]*?)?>)[\s\S])*?<\/\1>)*?<\/\1>)*?)<\/\1>/ig, e),
                a = a.replace(/<(span)(\s+[^>]*?)?\s+class\s*=\s*"Apple-style-span"(\s+[^>]*?)?>(((?!<\1(\s+[^>]*?)?>)[\s\S]|<\1(\s+[^>]*?)?>((?!<\1(\s+[^>]*?)?>)[\s\S])*?<\/\1>)*?)<\/\1>/ig, e),
                a = a.replace(/<(span)(\s+[^>]*?)?\s+class\s*=\s*"Apple-style-span"(\s+[^>]*?)?>(((?!<\1(\s+[^>]*?)?>)[\s\S])*?)<\/\1>/ig, e);
                a = a.replace(/(<(\w+))((?:\s+[\w\-:]+\s*=\s*(?:"[^"]*"|'[^']*'|[^>\s]+))*)\s*(\/?>)/g,
                function(a, b, e, c, d) {
                    var e = e.toLowerCase(),
                    f,
                    c = c.replace(/\s+_xhe_(?:src|href)\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/i,
                    function(a, b) {
                        f = b.match(/^(["']?)(.*)\1/)[2];
                        return ""
                    });
                    f && va && (f = V(f, va, B));
                    c = c.replace(/\s+([\w\-:]+)\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/g,
                    function(a, b, c) {
                        b = b.toLowerCase();
                        ...
                        if ("class" === b) {
                            ...
                            function(a, b, c, e, d) {
                                for (var f, h = 0; h < T.length; h++) if (a = T[h], e === a.n) {
                                    f = a.s;
                                    break
                                }
                                return b + c + ":" + f + d
        ...
        this.cleanWord = function(a) {
            ...
            if (0 < b && 3 > b && a.match(/mso(-|normal)|WordDocument|<table\s+[^>]*?x:str/i)) {
                for (var a = a.replace(/<\!--[\s\S]*?--\>|<!(--)?\[[\s\S]+?\](--)?>|<style(\s+[^>]*?)?>[\s\S]*?<\/style>/ig, ""), a = a.replace(/\r?\n/ig, ""), a = a.replace(/(<(\/?)([\w\-:]+))((?:\s+[\w\-:]+(?:\s*=\s*(?:"[^"]*"|'[^']*'|[^>\s]+))?)*)\s*(\/?>)/g,
                function(a, c, e, d, g, u) {
                    d = d.toLowerCase();
                    if (d.match(/^(link|img)$/) && g.match(/file:\/\//i) || d.match(/:/) || "span" === d && 2 === b || !e && (g = g.replace(/\s([\w\-:]+)(?:\s*=\s*("[^"]*"|'[^']*'|[^>\s]+))?/ig,
                    function(a, c, e) {
                        c = c.toLowerCase();
                        e = e.match(/^(["']?)(.*)\1/)[2];
                        if (c.match(/:/) || c.match(/^(class|lang|language|span)$/) || "td" === d && ("height" === c || "width" === c && !g.match(/\scolspan="\d+"/i))) return "";
                        return "style" === c ? 2 === b ? "": (e = e.replace(/"|&quot;/ig, "'").replace(/\s*([^:]+)\s*:\s*(.*?)(;|$)/ig,
                        function(a, b, c) {
                            return /^(color|background)$/i.test(b) ? b + ":" + c + ";": ""
                        }).replace(/^\s+|\s+$/g, "")) ? " " + c + '="' + e + '"': "": a
                    }), "span" === d && /^\s*$/.test(g))) return "";
                    return c + g + u
                }), c = 0; 3 > c; c++) a = a.replace(/<([^\s>]+)(\s+[^>]*)?>\s*<\/\1>/g,
                function(a, b) {
                    return b.match(/^a$/i) ? a: ""
                });
                for (c = 0; 3 > c; c++) a = a.replace(/<font(\s+[^>]+)><font(\s+[^>]+)>/ig,
                function(a, b, c) {
                    return "<font" + b + c + ">"
                })
            }
        ...
        this.formatXHTML = function(a, b) {
            ...
            function h(a, b, c) {
                if (m[a]) for (; E.last() && x[E.last()];) g(E.last());
                Z[a] && E.last() === a && g(a); (c = D[a] || !!c) || E.push(a);
                var e = [];
                e.push("<" + a);
                b.replace(y,
                function(a, b, c, d, f) {
            ...
            function g(a) {
                ...
                if (0 <= b) {
                    for (var c = E.length - 1; c >= b; c--) u("</" + E[c] + ">", E[c]);
                    E.length = b
                }
                "pre" === a && (B = !1, w--)
            }
            ...
            function u(a, c, e) {
                B || (a = a.replace(/(\t*\r?\n\t*)+/g, ""));
                if (!B && !0 === b) if (a.match(/^\s*$/)) G.push(a);
                else {
                    var d = m[c];
                    d ? (e && w++, "" === A && w--) : A && w++; ((d ? c: "") !== A || d) && r();
                    G.push(a);
                    "br" === c && r();
                    d && (D[c] || !e) && w--;
                    A = d ? c: ""
            ...
            function s(a, b, c, e) {
                ...
                return (c += ' style="' + d + '"') ? "<span" + c + ">" + e + "</span>": e
            }
            var D = e("area,base,basefont,br,col,frame,hr,img,input,isindex,link,meta,param,embed"),
            m = e("address,applet,blockquote,button,center,dd,dir,div,dl,dt,fieldset,form,frameset,h1,h2,h3,h4,h5,h6,hr,iframe,ins,isindex,li,map,menu,noframes,noscript,object,ol,p,pre,table,tbody,td,tfoot,th,thead,tr,ul,script"),
            x = e("a,abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,code,del,dfn,em,font,i,iframe,img,input,ins,kbd,label,map,object,q,s,samp,script,select,small,span,strike,strong,sub,sup,textarea,tt,u,var"),
            Z = e("colgroup,dd,dt,li,options,p,td,tfoot,th,thead,tr"),
            k = e("checked,compact,declare,defer,disabled,ismap,multiple,nohref,noresize,noshade,nowrap,readonly,selected"),
            i = e("script,style"),
            o = {
                b: "strong",
                i: "em",
            ...
            B = !1; v = q.exec(a);) {
                C = v.index;
                C > p && (p = a.substring(p, C), t ? z.push(p) : j(p));
                p = q.lastIndex;
                if (C = v[1]) if (C = d(C), t && C === t && (l(z.join("")), z = t = null), !t) {
                    g(C);
                    continue
                }
        ...
        this.toggleSource = function(a) {
            if (y !== a) {
                ...
                g = "";
                if (y) f = c.getSource(),
                e.html("").removeAttr("scroll").attr("class", "editMode" + Q),
                i ? b.contentEditable = "true": k.designMode = "On",
                qa && (c._exec("inserthtml", "-"), d("#" + za).show().focus().hide()),
                g = "\u6e90\u4ee3\u7801";
                else {
                ...
                q.find(".xheButton").not("[cmd=Source],[cmd=Fullscreen],[cmd=About]").toggleClass("xheEnabled").attr("aria-disabled", y ? !0 : !1);
                setTimeout(La, 300)
            }
        };
        this.showPreview = function() {
            ...
            b = c.getSource();
            a && (b = a(b));
            var a = "<html><head>" + P + "<title>\u9884\u89c8</title>" + (B ? '<base href="' + B + '"/>': "") + "</head><body>" + b + "</body></html>",
            b = window.screen,
        ...
        this.toggleFullscreen = function(a) {
            if (la !== a) {
                var a = d("#" + ja).find(".xheLayout"),
                b = d("#" + ja),
                e = jQuery.browser.version,
                e = i && (6 == e || 7 == e);
        ...
        this.showMenu = function(a, b) {
            ...
            e.click(function(a) {
                a = a.target;
                if (!d.nodeName(a, "DIV")) return c.loadBookmark(),
                b(d(a).closest("a").attr("v")),
                c.hidePanel(),
                !1
            }).mousedown(N);
            c.saveBookmark();
        ...
        this.showColor = function(a) {
            var b = d('<div class="xheColor"></div>'),
            e = [],
            f = Ta.length,
            h = 0;
            d.each(Ta,
            ...
            b.click(function(b) {
                b = b.target;
                if (d.nodeName(b, "A")) return c.loadBookmark(),
                a(d(b).attr("xhev")),
                c.hidePanel(),
                !1
            }).mousedown(N);
        ...
        this.showLink = function() {
            ...
            } else "" === u && n.val(g.defLinkText).closest("div").show();
            g.upLinkUrl && c.uploadInit(j, g.upLinkUrl, g.upLinkExt);
            b.click(function() {
                c.loadBookmark();
                var a = j.val(); ("" === a || 0 === h.length) && c._exec("unlink");
                if ("" !== a && "http://" !== a) {
                    var b = a.split(" "),
                    e = l.val(),
                    f = n.val();
                    if (1 < b.length) {
                        ...
                        f = "" !== u ? u: f ? f: a, i = 0, pb = b.length; i < pb; i++) a = b[i],
                        "" !== a && (a = a.split("||"), e = g, e = e.replace("xhe_tmpurl", a[0]), e = e.replace("xhe_tmptext", a[1] ? a[1] : f), Z.push(e));
                        c.pasteHTML(Z.join("&nbsp;"))
                    } else a = b[0].split("||"),
                    f || (f = a[0]),
                    f = a[1] ? a[1] : "" !== u ? "": f ? f: a[0],
                    0 === h.length ? (f ? c.pasteHTML('<a href="#xhe_tmpurl">' + f + "</a>") : c._exec("createlink", "#xhe_tmpurl"), h = d('a[href$="#xhe_tmpurl"]', k)) : f && !R && h.text(f),
                    L(h, "href", a[0]),
                    "" !== e ? h.attr("target", e) : h.removeAttr("target")
                }
                c.hidePanel();
                return ! 1
            });
        ...
        this.showAnchor = function() {
            var a = d('<div><label for="xheAnchorName">\u951a\u70b9\u540d\u79f0: </label><input type="text" id="xheAnchorName" value="" class="xheText" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="\u786e\u5b9a" /></div>'),
            b = c.getParent("a"),
            e = d("#xheAnchorName", a),
            f = d("#xheSave", a);
            if (1 === b.length) {
            ...
            s.click(function() {
                ...
                if ("" !== a && "http://" !== a) {
                    ...
                    if (1 < g.length) {
                        ...
                        w;
                        for (w in g) a = g[w],
                        "" !== a && (a = a.split("||"), m = v, m = m.replace("xhe_tmpurl", a[0]), a[1] && (m = '<a href="' + a[1] + '" target="_blank">' + m + "</a>"), t.push(m));
                        c.pasteHTML(t.join("&nbsp;"))
                    } else 1 === g.length && (a = g[0], "" !== a && (a = a.split("||"), 0 === b.length && (c.pasteHTML('<img src="' + a[0] + '#xhe_tmpurl" />'), b = d('img[src$="#xhe_tmpurl"]', k)), L(b, "src", a[0]), "" !== m && b.attr("alt", m), "" !== D ? b.attr("align", D) : b.removeAttr("align"), "" !== s ? b.attr("width", s) : b.removeAttr("width"), "" !== i ? b.attr("height", i) : b.removeAttr("height"), "" !== o ? b.attr("border", o) : b.removeAttr("border"), "" !== p ? b.attr("vspace", p) : b.removeAttr("vspace"), "" !== q ? b.attr("hspace", q) : b.removeAttr("hspace"), a[1] && (g = b.parent("a"), 0 === g.length && (b.wrap("<a></a>"), g = b.parent("a")), L(g, "href", a[1]), g.attr("target", "_blank"))))
        ...
        this.showEmbed = function(a, b, e, f, g, n, j) {
            var b = d(b),
            l = c.getParent('embed[type="' + e + '"],embed[classid="' + f + '"]'),
            u = d("#xhe" + a + "Url", b),
            r = d("#xhe" + a + "Width", b),
            s = d("#xhe" + a + "Height", b),
            a = d("#xheSave", b);
            n && c.uploadInit(u, n, j);
            1 === l.length && (u.val(L(l, "src")), r.val(l.attr("width")), s.val(l.attr("height")));
            a.click(function() {
                c.loadBookmark();
                var a = u.val();
                if ("" !== a && "http://" !== a) {
                    ...
                    n.test(b) || (b = 412);
                    n.test(j) || (j = 300);
                    var i = '<embed type="' + e + '" classid="' + f + '" src="xhe_tmpurl"' + g,
                    n = a.split(" ");
                    if (1 < n.length) {
                        var o, p = [],
                        i = i + ' width="xhe_width" height="xhe_height" />',
                        q;
                        for (q in n) a = n[q].split("||"),
                        o = i,
                        o = o.replace("xhe_tmpurl", a[0]),
                        o = o.replace("xhe_width", a[1] ? a[1] : b),
                        o = o.replace("xhe_height", a[2] ? a[2] : j),
                        "" !== a && p.push(o);
                        c.pasteHTML(p.join("&nbsp;"))
                    } else 1 === n.length && (a = n[0].split("||"), 0 === l.length && (c.pasteHTML(i.replace("xhe_tmpurl", a[0] + "#xhe_tmpurl") + " />"), l = d('embed[src$="#xhe_tmpurl"]', k)), L(l, "src", a[0]), l.attr("width", a[1] ? a[1] : b), l.attr("height", a[2] ? a[2] : j))
                } else 1 === l.length && l.remove();
                c.hidePanel();
                return ! 1
            });
            c.saveBookmark();
        ...
        this.showEmot = function(a) {
            ...
            r = e.count,
            e = e.list;
            if (r) for (e = 1; e <= r; e++) g++,
            n.push("<a href=\"javascript:void('" + e + '\')" style="background-image:url(' + f + e + '.gif);" emot="' + a + "," + e + '" xhev="" title="' + e + '" role="option">&nbsp;</a>'),
            0 === g % u && n.push("<br />");
            else d.each(e,
            function(b, c) {
                g++;
            ...
            j = d("<style>" + (s ? ".xheEmot div{width:" + (r + 20) + "px;height:" + s + "px;}": "") + ".xheEmot div a{width:" + j + "px;height:" + l + "px;}</style><div>" + n.join("") + "</div>").click(function(a) {
                var a = a.target,
                b = d(a);
                if (d.nodeName(a, "A")) return c.loadBookmark(),
            ...
            function(b, c) {
                i++;
                m.push("<li" + (a === b ? ' class="cur"': "") + ' role="presentation"><a href="javascript:void(\'' + c.name + '\')" group="' + b + '" role="tab" tabindex="0">' + c.name + "</a></li>")
            });
        ...
        this.showTable = function() {
            ...
            b = d("#xheTableRows", a),
            e = d("#xheTableColumns", a),
            f = d("#xheTableHeaders", a),
            g = d("#xheTableWidth", a),
            n = d("#xheTableHeight", a),
            j = d("#xheTableBorder", a),
            l = d("#xheTableCellSpacing", a),
            u = d("#xheTableCellPadding", a),
            r = d("#xheTableAlign", a),
            s = d("#xheTableCaption", a);
            d("#xheSave", a).click(function() {
                c.loadBookmark();
                var a = s.val(),
                d = j.val(),
                ...
                w = u.val(),
                z = r.val(),
                d = "<table" + ("" !== d ? ' border="' + d + '"': "") + ("" !== p ? ' width="' + p + '"': "") + ("" !== q ? ' height="' + q + '"': "") + ("" !== t ? ' cellspacing="' + t + '"': "") + ("" !== w ? ' cellpadding="' + w + '"': "") + ("" !== z ? ' align="' + z + '"': "") + ">";
                "" !== a && (d += "<caption>" + a + "</caption>");
                if ("row" === o || "both" === o) {
                    d += "<tr>";
                    for (a = 0; a < k; a++) d += '<th scope="col"></th>';
                    d += "</tr>";
                    i--
                }
                d += "<tbody>";
                for (a = 0; a < i; a++) {
                    d += "<tr>";
                    for (p = 0; p < k; p++) d = 0 === p && ("col" === o || "both" === o) ? d + '<th scope="row"></th>': d + "<td></td>";
                    d += "</tr>"
                }
        ...
        this.uploadInit = function(a, b, e) {
            function f(b) {
                ...
                var c = !1,
                e, d = b.length,
                f, h = []; (e = g.onUpload) && e(b);
                for (e = 0; e < d; e++) f = b[e],
                f = M(f, "string") ? f: f.url,
                "!" === f.substr(0, 1) && (c = !0, f = f.substr(1)),
                h.push(f);
                a.val(h.join(" "));
                c && a.closest(".xheDialog").find("#xheSave").click()
            }
            var h = d('<span class="xheUpload"><input type="text" style="visibility:hidden;" tabindex="-1" /><input type="button" value="' + g.upBtnText + '" class="xheBtn" tabindex="-1" /></span>'),
            n = d(".xheBtn", h),
            j = g.html5Upload,
            l = j ? g.upMultiple: 1;
            a.after(h);
            ...
            if ("!" === b.substr(0, 1)) n.click(function() {
                ...
                setTimeout(function() {
                    a.closest(".xheDialog").bind("dragenter dragover", N).bind("drop",
                    function(a) {
                        var a = a.originalEvent.dataTransfer,
                        d;
        ...
        this.startUpload = function(a, b, e, f) {
            function h(a, e) {
                ...
                d.err === $ || d.msg === $ ? alert(b + " \u4e0a\u4f20\u63a5\u53e3\u53d1\u751f\u9519\u8bef\uff01\r\n\r\n\u8fd4\u56de\u7684\u9519\u8bef\u5185\u5bb9\u4e3a: \r\n\r\n" + a) : d.err ? alert(d.err) : (n.push(d.msg), g = !0); (!g || e) && c.removeModal();
                e && g && f(n);
                return g
            }
            var n = [],
            ...
            l = j ? g.upMultiple: 1,
            i,
            r = d('<div style="padding:22px 0;text-align:center;line-height:30px;">\u6587\u4ef6\u4e0a\u4f20\u4e2d\uff0c\u8bf7\u7a0d\u5019\u2026\u2026<br /></div>'),
            s = '<img src="' + ua + 'img/loading.gif">';
            if (Ca || !j || a.nodeType && (!(i = a.files) || !i[0].name)) {
                if (!Wa(a.value, e)) return;
                r.append(s);
        ...
        this.html4Upload = function(a, b, c) {
            ...
            g = this,
            i = d('<iframe name="' + f + '" class="xheHideArea" />').appendTo("body"),
            j = d('<form action="' + b + '" target="' + f + '" method="post" enctype="multipart/form-data" class="xheHideArea"></form>').appendTo("body"),
            l = d(a),
            k = l.clone().attr("disabled", "true");
            l.before(k).appendTo(j);
            this.remove = function() {
                null !== g && (k.before(l).remove(), i.remove(), j.remove(), g = null)
            };
            this.onLoad = function() {
                var a = i[0].contentWindow.document,
                b = d(a.body).text();
                a.write("");
                g.remove();
                c(b, !0)
        ...
        this.html5Upload = function(a, b, c, d, g) {
            ...
            o = 0,
            m = this,
            p = 0; p < r; p++) o += b[p].size;
            this.remove = function() {
                l && (l.abort(), l = null)
            };
            this.uploadNext = function(a) {
                a && (s += b[k - 1].size, j(0)); (!a || a && !0 === d(a, k === r)) && k < r && i(b[k++], c, m.uploadNext,
                function(a) {
                    j(a)
                })
            };
        ...
        this.showIframeModal = function(a, b, e, f, g, i) {
            ...
            var b = d('<iframe frameborder="0" src="' + b.replace(/{editorRoot}/ig, K) + (/\?/.test(b) ? "&": "?") + "parenthost=" + location.host + '" style="width:100%;height:100%;display:none;" /><div class="xheModalIfmWait"></div>'),
            k = b.eq(0),
            r = b.eq(1);
            c.showModal(a, b, f, g, i);
            var s = k[0].contentWindow,
            o;
            j();
            k.load(function() {
                j();
                ...
                r.is(":visible") && (k.show().focus(), r.remove())
            })
        };
        ...
        this.showDialog = function(a, b) {
            var e = d('<div class="xheDialog"></div>'),
            f = d(a),
            h = d("#xheSave", f);
            if (1 === h.length) {
                ...
                if (!g.clickCancelDialog) {
                    sa = !1;
                    var i = d('<div class="xheFixCancel"></div>').appendTo("body").mousedown(N),
                    j = A.offset();
                    i.css({
                        left: j.left,
                        top: j.top,
        ...
        this.showPanel = function(a, b) {
            ...
            i = document.body;
            if (f + t.outerWidth() > (window.pageXOffset || h.scrollLeft || i.scrollLeft) + (h.clientWidth || i.clientWidth)) f -= t.outerWidth() - da.outerWidth();
            h = g.layerShadow;
            0 < h && ba.css({
                left: f + h,
                top: c + h,
            ...
            if ((h = d("#" + ja).offsetParent().css("zIndex")) && !isNaN(h)) ba.css("zIndex", parseInt(h, 10) + 1),
            t.css("zIndex", parseInt(h, 10) + 2),
            ca.css("zIndex", parseInt(h, 10) + 3);
            t.css({
                left: f,
                top: c
            }).show();
        ...
        this.hidePanel = function() {
            S && (da.removeClass("xheActive"), ba.hide(), ca.hide(), t.hide(), S = !1, sa || (d(".xheFixCancel").remove(), sa = !0), Qa = oa = !1, X = null, c.focus(), c.loadBookmark())
        };
        this.exec = function(a) {
            ...
            if (null === w) {
                ...
                if (1 === e.length) w.target = e
            }
            if (b.e) b.e.call(c);
            else switch (a = a.toLowerCase(), a) {
            case "cut":
                try {
                    if (k.execCommand(a), !k.queryCommandSupported(a)) throw "Error";
                } catch(f) {
        ...
        this._exec = function(a, b, e) {
            e || c.focus();
            return b !== $ ? k.execCommand(a, !1, b) : k.execCommand(a, !1, null)
        }
    };
    ra.settings = {
        skin: "default",
    ...
    d(function() {
        ...
        d.fn.val = function(d) {
            var i = this,
            p;
            return d === $ ? i[0] && (p = i[0].xheditor) ? p.getSource() : i.oldVal() : i.each(function() { (p = this.xheditor) ? p.setSource(d) : i.oldVal(d)
            })
        };
        d("textarea").each(function() {
            var i = d(this),
            o = i.attr("class");
            if (o && (o = o.match(/(?:^|\s)xheditor(?:\-(m?full|simple|mini))?(?:\s|$)/i))) i.xheditor(o[1] ? {
                tools: o[1]
            }: null)
        })
    })
