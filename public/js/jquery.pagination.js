...
jQuery.fn.pagination = function(maxentries, opts){
	...
	return this.each(function() {
		...
		function drawLinks() {
			...
			//pageSizeStr+=' style="width:25px;text-align:center;height:13px;line-height:13px;ime-mode:Disabled;" onchange="changePageSize(this)" onKeydown="return onlyNum(event)"/>&nbsp;</label>';
			var pageSizeArr = [20,50,100,200];
			var pageSizeStr = '<label>'+opts.perpage_text+'&nbsp;';
			pageSizeStr+= '<select id="pageSize" class="input_select" onchange="changePageSize(this)">';
			$.each(pageSizeArr,function(k,v){
				var selected = v==opts.items_per_page?'selected':'';
				pageSizeStr+= '<option value="'+v+'" '+selected+'>'+v+'</option>';
