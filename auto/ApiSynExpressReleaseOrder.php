...
$flagFile = APPLICATION_PATH_FILE . '/data/log/apiSynExpressReleaseOrder';
...
try {
	...
	$sql = "select distinct formal_code from order_processing where release_status = 1";
	//随机取运输方式
...
// 			}
			...
			$obj->compulsoryRelease($val['formal_code'], $loop);
			$runTime = time();
		}
	}
