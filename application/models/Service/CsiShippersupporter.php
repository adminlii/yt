<?php
class Service_CsiShippersupporter extends Common_Service
{
    /**
     * @var null
     */
    ...
    /**
     * @return Table_CsiShippersupporter|null
     */
    public static function getModelInstance()
    {
        if (is_null(self::$_modelClass)) {
            self::$_modelClass = new Table_CsiShippersupporter();
        }
