<?php
class Service_BsnShipperconsignee extends Common_Service
{
    /**
     * @var null
     */
    ...
    /**
     * @return Table_BsnShipperconsignee|null
     */
    public static function getModelInstance()
    {
        if (is_null(self::$_modelClass)) {
            self::$_modelClass = new Table_BsnShipperconsignee();
        }
     ...
     * @return mixed
     */
    public static function update($row, $value, $field = "bs_id")
    {
        $model = self::getModelInstance();
     ...
     * @return mixed
     */
    public static function delete($value, $field = "bs_id")
    {
        $model = self::getModelInstance();
     ...
     * @return mixed
     */
    public static function getByField($value, $field = 'bs_id', $colums = "*")
    {
        $model = self::getModelInstance();
    ...
    public  function getFields()
    {
        $row = array(
              ...
              'E31'=>'consignee_credentialsperiod',
