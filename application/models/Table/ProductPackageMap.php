<?php
class Table_ProductPackageMap
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_ProductPackageMap();
    }
    ...
    {
        return new Table_ProductPackageMap();
    }
     ...
     * @return mixed
     */
    public function update($row, $value, $field = "ppm_id")
    {
     ...
     * @return mixed
     */
    public function delete($value, $field = "ppm_id")
    {
        $where = $this->_table->getAdapter()->quoteInto("{$field}= ?", $value);
     ...
     * @return mixed
     */
    public function getByField($value, $field = 'ppm_id', $colums = "*")
    {
