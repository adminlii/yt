...
class Table_RunType
{
    ...
    {
        $this->_table = new DbTable_RunType();
    }
     ...
     * @return mixed
     */
    public function update($row, $value, $field = "run_type_id")
    {
     ...
     * @return mixed
     */
    public function delete($value, $field = "run_type_id")
    {
        $where = $this->_table->getAdapter()->quoteInto("{$field}= ?", $value);
     ...
     * @return mixed
     */
    public function getByField($value, $field = 'run_type_id', $colums = "*")
    {
    ...
    public function getByCondition($condition = array(), $type = '*', $pageSize = 0, $page = 1, $orderBy = "")
    {
        ...
        if(isset($condition["run_app_code"]) && $condition["run_app_code"] != ""){
            $select->where("run_app_code = ?",$condition["run_app_code"]);
        }
