<?php
class Table_ReceivingOrderMap
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_ReceivingOrderMap();
    }
    ...
    {
        return new Table_ReceivingOrderMap();
    }
     ...
     * @return mixed
     */
    public function update($row, $value, $field = "rom_id")
    {
     ...
     * @return mixed
     */
    public function delete($value, $field = "rom_id")
    {
        $where = $this->_table->getAdapter()->quoteInto("{$field}= ?", $value);
     ...
     * @return mixed
     */
    public function getByField($value, $field = 'rom_id', $colums = "*")
    {
