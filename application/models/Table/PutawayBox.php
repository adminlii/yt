<?php
class Table_PutawayBox
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_PutawayBox();
    }
    ...
    public function getByCondition($condition = array(), $type = '*', $pageSize = 0, $page = 1, $orderBy = "")
    {
        ...
        if(isset($condition["bb_quantity"]) && $condition["bb_quantity"] != ""){
            $select->where("bb_quantity = ?",$condition["bb_quantity"]);
        }
