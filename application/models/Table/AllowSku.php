<?php
class Table_AllowSku
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_AllowSku();
    }
    ...
    public function getByCondition($condition = array(), $type = '*', $pageSize = 0, $page = 1, $orderBy = "")
    {
        ...
        if(isset($condition["as_add_time"]) && $condition["as_add_time"] != ""){
            $select->where("as_add_time = ?",$condition["as_add_time"]);
        }
        /*CONDITION_END*/
        if ('count(*)' == $type) {
