<?php
class Table_MagentoOrderBillingAddress
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_MagentoOrderBillingAddress();
    }
    ...
    {
        return new Table_MagentoOrderBillingAddress();
    }
     ...
     * @return mixed
     */
    public function update($row, $value, $field = "moba_id")
    {
     ...
     * @return mixed
     */
    public function delete($value, $field = "moba_id")
    {
        $where = $this->_table->getAdapter()->quoteInto("{$field}= ?", $value);
     ...
     * @return mixed
     */
    public function getByField($value, $field = 'moba_id', $colums = "*")
    {
