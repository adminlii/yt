<?php
class Table_ShopifyOrderRefunds
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_ShopifyOrderRefunds();
    }
    ...
    {
        return new Table_ShopifyOrderRefunds();
    }
    ...
    public function getByCondition($condition = array(), $type = '*', $pageSize = 0, $page = 1, $orderBy = "")
    {
        ...
        if(isset($condition["restock"]) && $condition["restock"] != ""){
            $select->where("restock = ?",$condition["restock"]);
        }
