<?php
class Table_BsnShipperconsignee
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_BsnShipperconsignee();
    }
    ...
    {
        return new Table_BsnShipperconsignee();
    }
     ...
     * @return mixed
     */
    public function update($row, $value, $field = "bs_id")
    {
     ...
     * @return mixed
     */
    public function delete($value, $field = "bs_id")
    {
        $where = $this->_table->getAdapter()->quoteInto("{$field}= ?", $value);
     ...
     * @return mixed
     */
    public function getByField($value, $field = 'bs_id', $colums = "*")
    {
    ...
    public function getByCondition($condition = array(), $type = '*', $pageSize = 0, $page = 1, $orderBy = "")
    {
        ...
        if(isset($condition["consignee_credentialsperiod"]) && $condition["consignee_credentialsperiod"] != ""){
            $select->where("consignee_credentialsperiod = ?",$condition["consignee_credentialsperiod"]);
        }
