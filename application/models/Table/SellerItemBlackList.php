<?php
class Table_SellerItemBlackList
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_SellerItemBlackList();
    }
    ...
    {
        return new Table_SellerItemBlackList();
    }
     ...
     * @return mixed
     */
    public function update($row, $value, $field = "sibl_id")
    {
     ...
     * @return mixed
     */
    public function delete($value, $field = "sibl_id")
    {
        $where = $this->_table->getAdapter()->quoteInto("{$field}= ?", $value);
     ...
     * @return mixed
     */
    public function getByField($value, $field = 'sibl_id', $colums = "*")
    {
