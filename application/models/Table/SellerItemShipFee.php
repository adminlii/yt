<?php
class Table_SellerItemShipFee
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_SellerItemShipFee();
    }
    ...
    {
        return new Table_SellerItemShipFee();
    }
     ...
     * @return mixed
     */
    public function update($row, $value, $field = "sisf_id")
    {
     ...
     * @return mixed
     */
    public function delete($value, $field = "sisf_id")
    {
        $where = $this->_table->getAdapter()->quoteInto("{$field}= ?", $value);
     ...
     * @return mixed
     */
    public function getByField($value, $field = 'sisf_id', $colums = "*")
    {
