<?php
class Table_MessageLog
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_MessageLog();
    }
    ...
    public function getByCondition($condition = array(), $type = '*', $pageSize = 0, $page = 1, $orderBy = "")
    {
        ...
        if(isset($condition["log_content_en"]) && $condition["log_content_en"] != ""){
            $select->where("log_content_en = ?",$condition["log_content_en"]);
        }
        if(isset($condition["log_content_cn"]) && $condition["log_content_cn"] != ""){
            $select->where("log_content_cn = ?",$condition["log_content_cn"]);
        }
        /*CONDITION_END*/
        if ('count(*)' == $type) {
