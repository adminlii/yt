<?php
class Table_EbayOrderSupplying
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_EbayOrderSupplying();
    }
    ...
    {
        return new Table_EbayOrderSupplying();
    }
    ...
    public function getByCondition($condition = array(), $type = '*', $pageSize = 0, $page = 1, $orderBy = "")
    {
        ...
        if(isset($condition["count"]) && $condition["count"] != ""){
            $select->where("count = ?",$condition["count"]);
        }
        /*CONDITION_END*/
        if ('count(*)' == $type) {
