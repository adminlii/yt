<?php
class Table_AmazonLookupImageSet
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_AmazonLookupImageSet();
    }
    ...
    {
        return new Table_AmazonLookupImageSet();
    }
    ...
    public function getByCondition($condition = array(), $type = '*', $pageSize = 0, $page = 1, $orderBy = "")
    {
        ...
        if(isset($condition["al_id"]) && $condition["al_id"] != ""){
            $select->where("al_id = ?",$condition["al_id"]);
        }
