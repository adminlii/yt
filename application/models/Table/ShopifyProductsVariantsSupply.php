<?php
class Table_ShopifyProductsVariantsSupply
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_ShopifyProductsVariantsSupply();
    }
    ...
    {
        return new Table_ShopifyProductsVariantsSupply();
    }
    ...
    public function getByCondition($condition = array(), $type = '*', $pageSize = 0, $page = 1, $orderBy = "")
    {
        ...
        if(isset($condition["shopify_product_id"]) && $condition["shopify_product_id"] != ""){
            $select->where("shopify_product_id = ?",$condition["shopify_product_id"]);
        }
        ...
        if(isset($condition["shopify_product_status"]) && $condition["shopify_product_status"] != ""){
            $select->where("shopify_product_status = ?",$condition["shopify_product_status"]);
        }
