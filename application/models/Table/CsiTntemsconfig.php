<?php
class Table_CsiTntemsconfig
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_CsiTntemsconfig();
    }
    ...
    {
        return new Table_CsiTntemsconfig();
    }
    ...
    public function getByCondition($condition = array(), $type = '*', $pageSize = 0, $page = 1, $orderBy = "")
    {
        ...
        if(isset($condition["acount"]) && $condition["acount"] != ""){
        	$select->where("acount = ?",$condition["acount"]);
        }
        /*CONDITION_END*/
