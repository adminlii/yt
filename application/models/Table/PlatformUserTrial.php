<?php
class Table_PlatformUserTrial
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_PlatformUserTrial();
    }
    ...
    {
        return new Table_PlatformUserTrial();
    }
     ...
     * @return mixed
     */
    public function update($row, $value, $field = "put_id")
    {
     ...
     * @return mixed
     */
    public function delete($value, $field = "put_id")
    {
        $where = $this->_table->getAdapter()->quoteInto("{$field}= ?", $value);
     ...
     * @return mixed
     */
    public function getByField($value, $field = 'put_id', $colums = "*")
    {
