<?php
class Table_MagentoOrderStatusHistory
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_MagentoOrderStatusHistory();
    }
    ...
    {
        return new Table_MagentoOrderStatusHistory();
    }
     ...
     * @return mixed
     */
    public function update($row, $value, $field = "mosh_id")
    {
     ...
     * @return mixed
     */
    public function delete($value, $field = "mosh_id")
    {
        $where = $this->_table->getAdapter()->quoteInto("{$field}= ?", $value);
     ...
     * @return mixed
     */
    public function getByField($value, $field = 'mosh_id', $colums = "*")
    {
