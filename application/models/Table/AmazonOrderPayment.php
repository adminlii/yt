<?php
class Table_AmazonOrderPayment
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_AmazonOrderPayment();
    }
    ...
    {
        return new Table_AmazonOrderPayment();
    }
     ...
     * @return mixed
     */
    public function update($row, $value, $field = "aop_id")
    {
     ...
     * @return mixed
     */
    public function delete($value, $field = "aop_id")
    {
        $where = $this->_table->getAdapter()->quoteInto("{$field}= ?", $value);
     ...
     * @return mixed
     */
    public function getByField($value, $field = 'aop_id', $colums = "*")
    {
