<?php
class Table_ShopifyOrderShippingLines
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_ShopifyOrderShippingLines();
    }
    ...
    {
        return new Table_ShopifyOrderShippingLines();
    }
     ...
     * @return mixed
     */
    public function update($row, $value, $field = "sosl_id")
    {
     ...
     * @return mixed
     */
    public function delete($value, $field = "sosl_id")
    {
        $where = $this->_table->getAdapter()->quoteInto("{$field}= ?", $value);
     ...
     * @return mixed
     */
    public function getByField($value, $field = 'sosl_id', $colums = "*")
    {
