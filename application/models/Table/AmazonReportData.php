<?php
class Table_AmazonReportData
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_AmazonReportData();
    }
    ...
    {
        return new Table_AmazonReportData();
    }
    ...
    public function getByCondition($condition = array(), $type = '*', $pageSize = 0, $page = 1, $orderBy = "")
    {
        ...
        if(isset($condition["ReportId"]) && $condition["ReportId"] != ""){
            $select->where("ReportId = ?",$condition["ReportId"]);
        }
