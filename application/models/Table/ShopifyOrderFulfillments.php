<?php
class Table_ShopifyOrderFulfillments
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_ShopifyOrderFulfillments();
    }
    ...
    {
        return new Table_ShopifyOrderFulfillments();
    }
    ...
    public function getByCondition($condition = array(), $type = '*', $pageSize = 0, $page = 1, $orderBy = "")
    {
        ...
        if(isset($condition["tracking_company"]) && $condition["tracking_company"] != ""){
            $select->where("tracking_company = ?",$condition["tracking_company"]);
        }
