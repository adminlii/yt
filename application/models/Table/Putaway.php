...
class Table_Putaway
{
    ...
    {
        $this->_table = new DbTable_Putaway();
    }
     ...
     * @return mixed
     */
    public function update($row, $value, $field = "putaway_id")
    {
     ...
     * @return mixed
     */
    public function delete($value, $field = "putaway_id")
    {
        $where = $this->_table->getAdapter()->quoteInto("{$field}= ?", $value);
     ...
     * @return mixed
     */
    public function getByField($value, $field = 'putaway_id', $colums = "*")
    {
