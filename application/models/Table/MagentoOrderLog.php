<?php
class Table_MagentoOrderLog
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_MagentoOrderLog();
    }
    ...
    {
        return new Table_MagentoOrderLog();
    }
     ...
     * @return mixed
     */
    public function update($row, $value, $field = "mol_id")
    {
     ...
     * @return mixed
     */
    public function delete($value, $field = "mol_id")
    {
        $where = $this->_table->getAdapter()->quoteInto("{$field}= ?", $value);
     ...
     * @return mixed
     */
    public function getByField($value, $field = 'mol_id', $colums = "*")
    {
