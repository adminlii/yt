<?php
class Table_SellerItemSupLog
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_SellerItemSupLog();
    }
    ...
    {
        return new Table_SellerItemSupLog();
    }
     ...
     * @return mixed
     */
    public function update($row, $value, $field = "sisl_id")
    {
     ...
     * @return mixed
     */
    public function delete($value, $field = "sisl_id")
    {
        $where = $this->_table->getAdapter()->quoteInto("{$field}= ?", $value);
     ...
     * @return mixed
     */
    public function getByField($value, $field = 'sisl_id', $colums = "*")
    {
