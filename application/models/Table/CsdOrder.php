...
class Table_CsdOrder
{
    ...
    {
        $this->_table = new DbTable_CsdOrder();
    }
    ...
    public function getByCondition($condition = array(), $type = '*', $pageSize = 0, $page = 1, $orderBy = "", $groupBy = '')
    {
        ...
        if($type == 'count(*)'){
            ...
            $select->joinInner('csd_shipperconsignee', $table . '.order_id = csd_shipperconsignee.order_id', '*');
        }
