<?php
class Table_ProductCombineRelationLog
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_ProductCombineRelationLog();
    }
    ...
    {
        return new Table_ProductCombineRelationLog();
    }
     ...
     * @return mixed
     */
    public function update($row, $value, $field = "pcrl_id")
    {
     ...
     * @return mixed
     */
    public function delete($value, $field = "pcrl_id")
    {
        $where = $this->_table->getAdapter()->quoteInto("{$field}= ?", $value);
     ...
     * @return mixed
     */
    public function getByField($value, $field = 'pcrl_id', $colums = "*")
    {
