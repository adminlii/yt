<?php
class Table_ShopifyOrderLog
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_ShopifyOrderLog();
    }
    ...
    {
        return new Table_ShopifyOrderLog();
    }
    ...
    public function getByCondition($condition = array(), $type = '*', $pageSize = 0, $page = 1, $orderBy = "")
    {
        ...
        if(isset($condition["shopify_order_id"]) && $condition["shopify_order_id"] != ""){
            $select->where("shopify_order_id = ?",$condition["shopify_order_id"]);
        }
