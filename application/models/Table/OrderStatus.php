...
class Table_OrderStatus
{
     ...
     * @return mixed
     */
    public function update($row, $value, $field = "order_status_id")
    {
     ...
     * @return mixed
     */
    public function delete($value, $field = "order_status_id")
    {
        $where = $this->_table->getAdapter()->quoteInto("{$field}= ?", $value);
     ...
     * @return mixed
     */
    public function getByField($value, $field = 'order_status_id', $colums = "*")
    {
    ...
    public function getByCondition($condition = array(), $type = '*', $pageSize = 0, $page = 1, $orderBy = "")
    {
        ...
        if(isset($condition["order_status_code"]) && $condition["order_status_code"] != ""){
            $select->where("order_status_code = ?",$condition["order_status_code"]);
        }
