<?php
class Table_ProductQtyWarning
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_ProductQtyWarning();
    }
    ...
    {
        return new Table_ProductQtyWarning();
    }
     ...
     * @return mixed
     */
    public function update($row, $value, $field = "pqw_id")
    {
     ...
     * @return mixed
     */
    public function delete($value, $field = "pqw_id")
    {
        $where = $this->_table->getAdapter()->quoteInto("{$field}= ?", $value);
     ...
     * @return mixed
     */
    public function getByField($value, $field = 'pqw_id', $colums = "*")
    {
