<?php
class Table_SupplierProduct
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_SupplierProduct();
    }
    ...
    {
        return new Table_SupplierProduct();
    }
    ...
    public function getByCondition($condition = array(), $type = '*', $pageSize = 0, $page = 1, $orderBy = "")
    {
        ...
        if(isset($condition["sp_update_time"]) && $condition["sp_update_time"] != ""){
            $select->where("sp_update_time = ?",$condition["sp_update_time"]);
        }
        /*CONDITION_END*/
        if ('count(*)' == $type) {
