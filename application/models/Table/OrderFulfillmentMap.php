<?php
class Table_OrderFulfillmentMap
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_OrderFulfillmentMap();
    }
    ...
    {
        return new Table_OrderFulfillmentMap();
    }
    ...
    public function getByCondition($condition = array(), $type = '*', $pageSize = 0, $page = 1, $orderBy = "")
    {
        ...
        if(isset($condition["shipping_method_mark"]) && $condition["shipping_method_mark"] != ""){
            $select->where("shipping_method_mark = ?",$condition["shipping_method_mark"]);
        }
