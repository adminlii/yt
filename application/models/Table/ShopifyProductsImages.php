<?php
class Table_ShopifyProductsImages
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_ShopifyProductsImages();
    }
    ...
    {
        return new Table_ShopifyProductsImages();
    }
    ...
    public function getByCondition($condition = array(), $type = '*', $pageSize = 0, $page = 1, $orderBy = "")
    {
        ...
        if(isset($condition["src"]) && $condition["src"] != ""){
            $select->where("src = ?",$condition["src"]);
        }
