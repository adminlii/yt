 ...
 */
class Amazon_ListOrderItemsService {
	/**
	 * 日志文件名
	 * @var unknown_type
	 */
	private static $log_name = 'amazonListOrderItems_';
	...
	/**
	 * 获得亚马逊订单Itmes
	 * @param unknown_type $countryCode	$amazonOrderId	amazon订单ID
	 */
	public function getListOrderItems($amazonOrderId){
		$return = array(
				'ask'=>0,
				'message'=>'',
				'data'=>''
