<?php
    ...
    * http://aws.amazon.com
    ***********************************************************************/
    define('AWS_ACCESS_KEY_ID', 'AKIAIG3NK4J5OI3LVGLQ');//<Your Access Key ID>
    define('AWS_SECRET_ACCESS_KEY', '6zyB7/P1aKu156NI0Ncuv2E0/aVUjpslnG/saemz');//<Your Secret Key>
    ...
    ***********************************************************************/
    define('APPLICATION_NAME', 'EccangPhpScratchpad');//<Your Application Name>
    define('APPLICATION_VERSION', '1.0');//<Your Application Version or Build Number>
    ...
    * marketplace ID.
    ***********************************************************************/
    define ('MERCHANT_ID', 'A2FDPRAQE1CP9M');//<Your Merchant Id>
    define ('MARKETPLACE_ID', 'A1F83G8C2ARO7P');//<Your Marketplace Id>
