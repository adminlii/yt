...
class Common_Barcode
{
	public static function barcode($text){
		...
		$config = new Zend_Config(array(
			'barcode'        => 'code128',
			'barcodeParams'  => array('text' => $text,'barheight' => '30',),
			'renderer'       => "image",
	...
	public static function barcode1($text){
		$config = new Zend_Config ( array (
				'barcode' => 'code128',
				'barcodeParams' => array (
						'text' => $text ,
...
// 						'width'=>'240', 
	...
	public static function barcode2($text){
		$config = new Zend_Config ( array (
				'barcode' => 'code128',
				'barcodeParams' => array (
						'text' => $text ,
    ...
    public static function outImage($condition){
    ...
    public function Barcode39($barcode, $width, $height, $quality, $format, $text) {
        ...
        $nChars = (strlen($barcode) + 1) * ((6 * $NarrowRatio) + (3 * $WideRatio) + ($QuietRatio));
        $Pixels = $width / $nChars;
