	...
	<div id="ez-wms-edit-dialog" style="display: none;">
		<table class="dialog-module" border="0" cellpadding="0" cellspacing="0">
			<tbody>
				...
				<tr>
					<td class="dialog-module-title"><{t}>title<{/t}>:</td>
					<td>
				...
				<tr>
					<td class="dialog-module-title"><{t}>titleEn<{/t}>:</td>
					<td>
				...
				<tr>
					...
					<td>
						<input type="text" name="E5" id="E5" validator="numeric" maxlength="3" value="0" err-msg="<{t}>numeric<{/t}>" class="input_text" />
					</td>
				</tr>
			</tbody>
		</table>
