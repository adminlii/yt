...
<div id="module-container">
	<div id="main_left" style="width: 49%; float: left; border: 1px solid #DDDDDD; height: 180px; margin-top: 2px; display: none;">
		<div style="padding-left: 5px; padding-top: 5px;">
			<div style="float: left;">
				<img id="avatar" height="170px" style="border: 1px solid #D1E7FC; cursor: pointer;" src="/images/modeling/default.png" title="是的，我就是来卖萌的~">
			</div>
			<div style="float: left; padding-left: 5px; padding-top: 15px;">
				<!-- 
				<h2 style="color:#E06B26;">修改密码：</h2>
				 -->
				<p>
					<span style="">XXXXXX</span>
					&nbsp;&nbsp;您好！
				</p>
				<p>
					<span style="font-weight: bold;">账户余额：</span>
				</p>
				<p style="line-height: 33px;">
					&nbsp;&nbsp;
					<span style="font-size: 30px; font-weight: 300;">17520.10</span>
					&nbsp;RMB
				</p>
				<p style="line-height: 60px;">
					<input type="button" style="margin-left: 6px;" class="publicBtn2" value="充值" name="" id="recharge">
					<input type="button" style="margin-left: 15px;" class="publicBtn6" value="交易明细" name="" id="transactionDetails">
				</p>
			</div>
		</div>
	</div>
	<div id="main_left" style="width: 49%; float: left; border: 1px solid #DDDDDD; height: 192px; margin-top: 2px;">
		<div style="padding-left: 5px; padding-top: 5px;">
			<h2 style="color: #E06B26;">修改密码：</h2>
			<p>
				<strong>注意</strong>
			...
			<p>
				<span style="">&nbsp;&nbsp;1、密码不能超过16位.</span>
			</p>
			<p>
				<span style="">&nbsp;&nbsp;2、必须存在数字和字母的组合.</span>
			</p>
			<br />
			<h2 style="color: #E06B26;">关于帮助：</h2>
			<p>
				<span style="">
					&nbsp;&nbsp;请点击右上角的“问好(<strong style="color:#0090E1;">?</strong>)”.
				</span>
			</p>
		</div>
	</div>
	<div id="main_right" style="float: right; width: 50%;">
		...
		<!-- 修改密码--结束 -->
		<!-- 设置优先登陆的系统--开始 -->
		<form id="priority_login_params">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table-module" style="max-height: 120px; display: none;" id="priority_login_table">
				<tr class="table-module-title">
					<td width="50%" class="ec-center"></td>
				</tr>
				<tr class="table-module-b1">
					<td></td>
				</tr>
