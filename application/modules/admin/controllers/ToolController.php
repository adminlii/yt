...
//                }
    ...
    public function testAction(){
        ...
        $obj->createOrderToService('DHL',1);
    }
    
    public function test1Action(){
        $obj = new API_Common_ServiceExpressCreateOrder();
        $obj->notifyOrderToService('DHL',1);
    }
    ...
    public function wlAction(){
        ...
        if (empty($class)) {
            throw new Exception("无法获取到对应的数据映射类");
        }
        ...
        $param["code"]='YT15286100008200001';
        $param["hawbcode"]='shipper_hawbcode';
        //print_r($obj->gettrack_pross($param));
        
        $process_tarck = new Process_Track();
