...
<table cellpadding="0" cellspacing="0" class="tabBq">
		...
		<td style="font-size: 7px; border: solid #000 1px;border-bottom:#000 solid 0px;height: 0.8cm;" colspan="2" >
			<table width="100%" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td style="width: 33%;" align="center"><b style="font-size: 16px"><{$data.address.country.country_code}>&nbsp;&nbsp;<{$data.address.country.country_name}></b></td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<tr>
		<td align="center" style=" height:0.4cm; border-left: 1px #000 solid;border-bottom: 1px #000 solid;border-right: 1px #000 solid;">&nbsp;<b><!-- <{$data.zone_area}> --></b></td>
	</tr>
