...
<table class="tabBq" border="0" cellpadding="0" cellspacing="0">
    <tbody>
    <tr>
        <td style="border: 0px; font-size: 11px; width: 3.4cm; padding-top: 0cm;" align="left" valign="top">
            <{$data.sm.sm_return_address}>
        </td>
        <td style="width: 6.4cm; height: 2.0cm; padding: 0; font-size: 25px;" align="right" valign="top">
             <img src="/images/label/ppi_eng_24_30x106.jpg" style="width:6cm ;"> 
            <!--<img src="/images/label/ppi_eng_24_300x85.png" style="width:6cm ;">-->
            
        </td>
    </tr>
    <tr>
        <td colspan="2"
            style="border: 0px; border-top: 0px; border-top-style: dashed; width: 9.5cm; padding: 0; height: 3.5cm"
            align="left" valign="top">
            <div style="font-size: 15px; float: left; font-family:Arial, Helvetica, sans-serif; word-spacing: normal; width: 7.2cm;">
                <div>
                ...
                <div style="width: 1.1cm;float: left;">
                	<b>Adds:&nbsp;</b> 
                </div>
                <div style="width: 6cm;float: left;">
            ...
            <div style="float: left; width: 2.2cm; font-size: 25px; text-align: right">
    ...
    <tr>
        <td style="border: 0" colspan="2">
            <table style="border-bottom: 0; border-left: 0; border-right: 0; border-top: 0; font-size: 8px; width: 9.8cm; table-layout: fixed;"
                ...
                <tr>
                    <td style="text-align: center;" colspan="2">
                        <table cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td style="font-size: 12px;width:7.1cm; text-align: center;" valign="top">
                ...
                <tr>
                    <td colspan="2" style="padding-left: 3px;border: solid #000 1px;font-size: 9px;" align="left">
                        <!-- LYTPY -->
                        <{$data.sm.sm_short_name}>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; <b>[</b>&nbsp;&nbsp;<b>]</b>&nbsp;Ref No: <{$data.order.order_code}>
                    </td>
                </tr>
                <tr>
                    <td style="font-size: 9px; border: solid #000 1px;" colspan="2">
