<div id = "warp">
	...
	<div class="div1 bt1">
	 <p style="padding: 76px 96px;font-size: 30px;line-height: 30px;height: 30px;">PROFOMA INVOICE</p>
	</div>
	<div class="clear"></div>
	...
	<div class="div3 bt1 bt2">
		...
		<div>
			<div class="bt3 bt4 invoice" style="width:45px;float:left;"><p class="p1"><{$ink+1}></p></div>
			<div class="bt3 bt4 invoice" style="width:406px;float:left;"><p class="p1"><{$inv.invoice_note}></p></div>
			<div class="bt3  invoice" style="width:45px;float:left;"><p class="p1"><{$inv.invoice_quantity}></p></div>
			<div class="clear"></div>
		</div>
		<{/foreach}>
	</div>
	<div class="div3 bt1">
		...
		<div>
			<div class="bt3 bt4 invoice" style="width:173px;float:left;"><p  class="p1"><{$inv1.invoice_shipcode}></p></div>
			<div class="bt3 bt4 invoice" style="width:150px;float:left;"><p class="p1"><{$inv1.invoice_unitcharge}></p></div>
			<div class="bt3  invoice" style="width:173px;float:left;"><p class="p1"><{$inv1.invoice_proplace}></p></div>
			<div class="clear"></div>
		</div>
		<{/foreach}>
	</div>
