<?php
class Order_CsiShipperTrailerAddressController extends Ec_Controller_Action
{
    ...
    public function listAction()
    {
        if ($this->_request->isPost()) {
            ...
            if ($count) {
                ...
                $rows = $this->serviceClass->getByCondition($condition,$showFields, $pageSize, $page, array('shipper_account desc'));
                $return['data'] = $rows;
                $return['state'] = 1;
                $return['message'] = "";
            }
        ...
        echo Ec::renderTpl($this->tplDirectory . "csi_shipper_trailer_address_index.tpl", 'layout');
    }
