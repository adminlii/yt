...
<div id="sidebarIcon" style="display: none;">
    ...
    <div class="menuicon">
        ...
        <dl onmouseover="showThisSubMenu(this,'menuicon<{$submenu.menu.um_id}>')" onmouseout="closeThisSubMenu(this,'menuicon<{$submenu.menu.um_id}>')">
            <dt   id="test">
...
<div id="sidebar">
    ...
    <div class="menu" id="menu-module">
        ...
        <dl>
            ...
            <dd>
            <{/if}>
            <a href="javascript:void(0);" class="sub-menu-id-<{$sub.ur_id}>" onclick="leftMenu('<{$sub.ur_id}>','<{$sub.value}>','<{$sub.ur_url}>?quick=<{$sub.ur_id}>')"><{$sub.value}></a></dd>
            <{/foreach}>
        </dl>
        <{/foreach}>
    </div>
