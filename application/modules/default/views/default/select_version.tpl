...
<div id="content">
	...
	<div class="login_head">
		<div class="login_logo">
			<a href="/"><img src="<{$logo}>" alt="" style='width:100%;height:60%;'/></a>
		</div>
					...
					<form method="post" id="ec_login" action="/default/index/login">
						<table width="95%" border="0" cellpadding="0" cellspacing="0">
							...
							<tr>
								...
								<td>
									<input type="submit" id="login" value="<{t}>logoing<{/t}>" class="login_Btn" style="width:120px;border-radius:10px;margin-left:30px;" />
