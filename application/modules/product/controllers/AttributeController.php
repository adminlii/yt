<?php
class Product_AttributeController extends Ec_Controller_Action
{
    ...
    public function listAction()
    {
        if ($this->_request->isPost()) {
            ...
            if ($count) {
                ...
                $rows = $this->serviceClass->getLeftJoinTemplateByCondition($condition,$showFields, $pageSize, $page, array('pa_id desc'));
                $return['data'] = $rows;
                $return['state'] = 1;
                $return['message'] = "";
            }
        ...
        echo Ec::renderTpl($this->tplDirectory . "product_attribute_index.tpl", 'layout');
    }
    ...
    public function getByJsonAction()
    {
        ...
        if (!empty($paramId) && $rows = $this->serviceClass->getByField($paramId, 'pa_id')) {
