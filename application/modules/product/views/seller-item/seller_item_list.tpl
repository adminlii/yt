...
<{include file='product/views/seller-item/seller_item_list.js'}>
</script>
<style>
<!--
#listForm .supply_qty {
					...
					<tr>
						<td>
							...
							<div class="pack_manager">
								...
								<input type="hidden" class="input_text keyToSearch" id="no_stock_online" name="no_stock_online" value="0,4,5,6">
								...
								<!-- <a href="javascript:void(0)" class='item_status' status='NoStockOnLine'><{t}>no_stock_online<{/t}></a> --> <!-- 无货在线 -->
		...
		<div class="opration_area0">
			<div class="opration_area">
				<div class="opDiv">
					...
					<!-- 补货日志 -->
					<input type="button" value="<{t}>replenishment_log<{/t}>" class="supLogBtn baseBtn" style='float: right;margin:0 5px 0 0;'>
					<!-- 无货在线设置-->
			...
			<table width="100%" cellspacing="0" cellpadding="0" border="0" class="table-module">
				<tbody>
					<tr class="table-module-title">
						...
						<td><{t}>product_sales_value<{/t}><!-- 售价 --></td>
						<td><{t}>salable<{/t}><!-- 可售数 -->/<{t}>has_sold<{/t}><!-- 已售数 --></td>
						<!-- <td><{t}>the_shelves_number<{/t}> --> <!-- 上架数 --> <!-- /<{t}>replenishment_number<{/t}> --> <!-- 补货数 --></td>
