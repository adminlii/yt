...
<form method='post' enctype="multipart/form-data" action='/product/fulfill-map/upload' id='upload_form' onsubmit='return false;'>
...
<div class="search-module-condition">
	...
	<a href="/file/fulfill-map.xls" target="_blank" style='color:red;'><{t}>download_template<{/t}><!-- 模板下载 --></a>
</div>
