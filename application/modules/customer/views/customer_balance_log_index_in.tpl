...
<script type="text/javascript">
    ...
    function syncLog(){
    	$.ajax({
            type:'POST',
            dataType:'json',
            url:'/customer/balance-log/sync-log',           
            success:function(json){
    ...
    $(function(){
    	setCustomerCode($('.customer_code').val());
    	syncLog();
    })
    function resetData(){
...
<div id="module-container">
    <div id="balanceLogDialog" style="display:none;" title="流水记录详情">
        ...
        <table class="table-module" border="0" cellpadding="0" cellspacing="0" style="float: right;">
            <tbody>
            <tr>
	           <td colspan="4" class="ec-center">
	           		账户信息
    ...
    <div id="search-module">
        <form id="searchForm" name="searchForm" class="submitReturnFalse">
            <div style="padding:0;display:none;">
								...
								<tr>
									<td>
										...
										<div class="pack_manager">
											<input type="hidden" class="input_text keyToSearch" id="E3" name="E3" value='3'>
            	...
            	<span class="searchFilterText" style="width: 90px;display:none;" ><{t}>customerCode<{/t}>：</span>
       			...
       			<input type="hidden" id="customer_code_is_exist" value="1">
            </div>
        ...
        <div id="customer_info" style="padding-left: 5px;padding-top: 5px;width: 365px; left: 430px;top: 0px;z-index: 1;display:none;">
