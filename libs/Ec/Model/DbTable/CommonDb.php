<?php
class Ec_Model_DbTable_CommonDb extends Zend_Db_Table {
	
// 	protected $_schema = 'wp';
	protected $_sequence = true;
	public function __construct($config = array(), $definition = null,$dbparams=array())
	{		
...
// 		}
		...
		if(empty($dbparams)){
			...
			$dbparams = $server->get('resources')->get('multidb')->get('db2')->toArray();
		}
