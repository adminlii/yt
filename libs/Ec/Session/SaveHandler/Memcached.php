<?php
class Ec_Session_SaveHandler_Memcached implements Zend_Session_SaveHandler_Interface {
	 ...
	 * Zend_Session_SaveHandler_Memcached . These are the configuration options
	 * for
	...
	public function __construct($config) {
		if ($config instanceof Zend_Config) {
			...
			throw new Zend_Session_SaveHandler_Exception ( '$config must be an instance of Zend_Config or array of key/value pairs containing ' . 'configuration options for Zend_Session_SaveHandler_Memcached .' );
		}
	 ...
	 *
	 * @param $lifetime int       	
	 * @param $overrideLifetime boolean
	 *       	 (optional)
