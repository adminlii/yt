<?php /* Smarty version Smarty-3.1.13, created on 2016-05-17 17:56:07
         compiled from "D:\yt1\application\modules\order\views\order\order_import.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14399572c5df6176660-70508132%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '083f83df911937090d2bd3b98c102469250af95c' => 
    array (
      0 => 'D:\\yt1\\application\\modules\\order\\views\\order\\order_import.tpl',
      1 => 1463478946,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14399572c5df6176660-70508132',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_572c5df62d2137_82422929',
  'variables' => 
  array (
    'baseTemplate' => 0,
    'o' => 0,
...
<?php if ($_valid && !is_callable('content_572c5df62d2137_82422929')) {function content_572c5df62d2137_82422929($_smarty_tpl) {?><?php if (!is_callable('smarty_block_t')) include 'D:\\yt1\\libs\\Smarty\\plugins\\block.t.php';
	...
	<div class="Tab">
		<ul>
			<li id="normal" style="position: relative;" class="mainStatus0 ">
				<a href="javascript:;" class="statusTag " onclick="leftMenu('52','<?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; echo smarty_block_t(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
单票录入<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
			...
			<li id="abnormal" style="position: relative;" class="mainStatus0 chooseTag">
				<a href="javascript:;" class="statusTag " onclick="leftMenu('24','<?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; echo smarty_block_t(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
批量上传<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
			...
			<li id="abnormal" style="position: relative;" class="mainStatus0">
				<a href="javascript:;" class="statusTag " onclick="leftMenu('get-import-batch','<?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; echo smarty_block_t(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
