<?php /* Smarty version Smarty-3.1.13, created on 2014-07-22 11:10:34
         compiled from "E:\Zend\workspaces\ruston_oms\application\modules\order\views\order\order_create_return.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2240653cdd62a4664e7-35509585%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '38aea8615bc321525ab7a78036fb6ba46df6f53d' => 
    array (
      0 => 'E:\\Zend\\workspaces\\ruston_oms\\application\\modules\\order\\views\\order\\order_create_return.tpl',
      1 => 1405996339,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2240653cdd62a4664e7-35509585',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53cdd62a74bcd8_27391238',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53cdd62a74bcd8_27391238')) {function content_53cdd62a74bcd8_27391238($_smarty_tpl) {?><?php if (!is_callable('smarty_block_t')) include 'E:\\Zend\\workspaces\\ruston_oms\\libs\\Smarty\\plugins\\block.t.php';
...
pls_select_warehouse<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
');
		        return;
		    }
...
return_orders<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</span></h1>
...
select_unsellable_product<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</a>
			</div>
			<a class="selectProductBtn" href="javascript:;" style='line-height:25px;'><?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; echo smarty_block_t(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
select_unsellable_product<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</a>
			<div style='clear: both;'></div>
			<table width="100%" cellspacing="0" cellpadding="0" border="0" class="table-module">
...
' id='ref_id'>
			...
			<input type="hidden" name='order_type' value='<?php if (isset($_smarty_tpl->tpl_vars['order']->value)&&$_smarty_tpl->tpl_vars['order']->value['order_type']){?><?php echo $_smarty_tpl->tpl_vars['order']->value['order_type'];?>
